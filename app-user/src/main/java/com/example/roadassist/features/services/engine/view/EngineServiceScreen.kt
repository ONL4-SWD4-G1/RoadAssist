package com.example.roadassist.features.services.engine.view
...
import com.example.roadassist.features.services.engine.viewmodel.EngineViewModel
import com.example.roadassist.theme.TextPrimary

private val engineIssues =
    listOf("Unusual noise", "Performance issue", "Smoke emission", "Fluid leak", "Other")

@Composable
fun EngineServiceScreen(
    onNavigateBack: () -> Unit,
    onBookService: () -> Unit,
    viewModel: EngineViewModel = viewModel(),
) {
    val uiState by viewModel.uiState.collectAsState()

    Scaffold(
        topBar = { UserTopBar("Engine", onNavigateBack) },
        ...
        Column(
            ...
            SectionHeader("Select the issue facing in Engine")
...
@Composable
fun EngineServiceScreenPreview() {
    EngineServiceScreen(onNavigateBack = {}, onBookService = {})
}
