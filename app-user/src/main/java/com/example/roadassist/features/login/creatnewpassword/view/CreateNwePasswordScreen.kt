...
fun CreateNewPasswordScreen(
    onUpdateClick: () -> Unit,
    onBackClick: () -> Unit,
    viewModel: com.example.roadassist.features.login.creatnewpassword.vm.CreateNewPasswordViewModel = viewModel()
) {
...
private fun CreateNewPasswordContent(
    uiState: com.example.roadassist.features.login.creatnewpassword.model.CreateNewPasswordUiState,
